    ...
    >
      <div
        ...
        style={{
          ...
          boxShadow: "0 24px 64px rgba(44,26,20,0.2)",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
          ...
          <button
            ...
            style={{
              ...
              color: textMuted, fontSize: 16, width: 30, height: 30,
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {wallets.length === 0 ? (
            <div style={{ textAlign: "center", padding: "24px 0", color: textMuted }}>
              <p style={{ margin: "0 0 4px", fontWeight: 600, color: textPrimary }}>No wallets detected</p>
              <p style={{ margin: "0 0 16px", fontSize: 13 }}>Install Petra to get started</p>
              <a
                ...
                style={{
                  ...
                  borderRadius: 999, background: pink, color: "#fff",
            ...
            wallets.map((wallet) => {
              const isReady = "readyState" in wallet
                ...
                >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <p style={{ margin: "2px 0 0", fontSize: 12, color: textMuted }}>
                      {isReady ? "Ready to connect" : "Click to install"}
                    </p>
                  </div>
